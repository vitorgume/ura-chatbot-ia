...
class MensagemRecontatoInativoG1DirecionamentoVendedorTest {
    ...
    void deveRetornarMensagemComNomeDoVendedor() {
        ...
        String esperado = "Perfeito, estou te redirecionando para a vendedora Carlos que logo entrará em contato. Você consegue chama-la nesse número ?";
    ...
    void deveRetornarMensagemMesmoComNomeVendedorNull() {
        ...
        String esperado = "Perfeito, estou te redirecionando para a vendedora null que logo entrará em contato. Você consegue chama-la nesse número ?";
        assertEquals(esperado, resultado);
    }
